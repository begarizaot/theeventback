...
export interface ApiAdminAdmin extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::admin.admin'> &
      Schema.Attribute.Private;
    Nav: Schema.Attribute.Component<'layout.menu-admin', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    url_spotify: Schema.Attribute.String;
  };
}
...
export interface ApiEventLocationEventLocation
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    events_id: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
    formatted_address: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    vicinity: Schema.Attribute.String;
  };
}

export interface ApiEventRestrictionEventRestriction
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_restrictions';
  info: {
    description: '';
    displayName: 'EventRestrictions';
    pluralName: 'event-restrictions';
    singularName: 'event-restriction';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiEventStatusEventStatus extends Struct.CollectionTypeSchema {
  collectionName: 'event_statuses';
  info: {
    displayName: 'EventStatus';
    pluralName: 'event-statuses';
    singularName: 'event-status';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artists_ids: Schema.Attribute.Relation<'manyToMany', 'api::artist.artist'>;
    categories_id: Schema.Attribute.Relation<
      'manyToOne',
      'api::category.category'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    event_locations_id: Schema.Attribute.Relation<
      ...
      'api::event-location.event-location'
    >;
    event_restriction_id: Schema.Attribute.Relation<
      'oneToOne',
      'api::event-restriction.event-restriction'
    >;
    event_status_id: Schema.Attribute.Relation<
      'oneToOne',
      'api::event-status.event-status'
    >;
    event_tickets_ids: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-ticket.event-ticket'
    >;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    colors: Schema.Attribute.Component<'shared.color', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    metas: Schema.Attribute.Component<'shared.meta', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    url_image_logo: Schema.Attribute.String;
  };
}
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    eventCarruselItem: Schema.Attribute.Component<'shared.events', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTeamAccessTeamAccess extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type_role_id: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiTeamTypeRoleTeamTypeRole
  extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    country_id: Schema.Attribute.Relation<'oneToOne', 'api::country.country'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email &
    ...
    firstName: Schema.Attribute.String;
    isOrganizer: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    lastName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
